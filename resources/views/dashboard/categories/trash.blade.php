...
@section('content')
    <div class="main-box styled-box">
        ...
        {{-- Table --}}
        <x-dashboard.tables.terms-table :records="$records" :trashedRecords="true" />
    </div>

    {{-- Modals --}}
    <x-dashboard.modals.multiple-delete form-action="{{ route('dashboard.terms.destroy') }}" :force-delete="true" />
    <x-dashboard.modals.target-delete :force-delete="true" />
    <x-dashboard.modals.multiple-restore form-action="{{ route('dashboard.terms.restore') }}" />
