...
@section('content')
    <div class="main-box styled-box">
        ...
        <div class="toolbar toolbar--joined toolbar--for-table">
            ...
            <div class="toolbar__buttons-wrapper">
                <x-global.buttoned-link
                    ...
                    style="shadowed"
                    link="{{ route('dashboard.channels.create') }}"
                    icon="add">Добавить
                </x-global.buttoned-link>
        ...
        {{-- Table --}}
        <x-dashboard.tables.channels-table :records="$records" />
    </div>

    {{-- Modals --}}
    <x-dashboard.modals.multiple-delete form-action="{{ route('dashboard.channels.destroy') }}" :force-delete="false" />
    <x-dashboard.modals.target-delete :force-delete="false" />
@endsection

@section('rightbar')
    <x-dashboard.filters.channels />
@endsection
