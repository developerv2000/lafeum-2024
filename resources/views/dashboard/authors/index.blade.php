...
@section('content')
    <div class="main-box styled-box">
        ...
        <div class="toolbar toolbar--joined toolbar--for-table">
            ...
            <div class="toolbar__buttons-wrapper">
                <x-global.buttoned-link
                    ...
                    style="shadowed"
                    link="{{ route('dashboard.authors.create') }}"
                    icon="add">Добавить
                </x-global.buttoned-link>
        ...
        {{-- Table --}}
        <x-dashboard.tables.authors-table :records="$records" />
    </div>

    {{-- Modals --}}
    <x-dashboard.modals.multiple-delete form-action="{{ route('dashboard.authors.destroy') }}" :force-delete="false" />
    <x-dashboard.modals.target-delete :force-delete="false" />
@endsection

@section('rightbar')
    <x-dashboard.filters.authors />
@endsection
