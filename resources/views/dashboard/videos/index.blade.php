...
@section('content')
    <div class="main-box styled-box">
        ...
        <div class="toolbar toolbar--joined toolbar--for-table">
            ...
            <div class="toolbar__buttons-wrapper">
                <x-global.buttoned-link
                    ...
                    style="shadowed"
                    link="{{ route('dashboard.videos.create') }}"
                    icon="add">Добавить
                </x-global.buttoned-link>
        ...
        {{-- Table --}}
        <x-dashboard.tables.videos-table :records="$records" />
    </div>

    {{-- Modals --}}
    <x-dashboard.modals.multiple-delete form-action="{{ route('dashboard.videos.destroy') }}" :force-delete="false" />
